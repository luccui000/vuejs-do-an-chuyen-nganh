                            ...
                            <ul>
                                <li v-for="payment in paymentMethods" :key="payment.id">
                                    <a href="#" class="payment-link">
                                        <img :src="payment.image" width="51" height="36" alt="">
                                    </a>
                                </li>
                            </ul>
                        </div>
...
export default {
    ...
    setup() {
        const paymentMethods = ref([
            { id: 1, image: require("@/assets/images/card1.jpg") },
            { id: 2, image: require("@/assets/images/card2.jpg") },
            { id: 3, image: require("@/assets/images/card3.jpg") },
            { id: 4, image: require("@/assets/images/card4.jpg") },
            { id: 5, image: require("@/assets/images/card5.jpg") },
        ]);
        return {
